...
Module Activtor
    ...
    End Function
    Public Function GetKeyActiveNumber()
        Dim Key As String
        Key = GetDriveSerialNumber() & My.Computer.Name & My.User.Name & My.Computer.Info.TotalPhysicalMemory * 360
        GetKeyActiveNumber = EncryptData(EncryptData(Key))
    End Function
End Module
